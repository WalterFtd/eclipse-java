...
public class StringDemo6 {
	 ...
	 * 转成大写toUpperCase()
	 * 
	 * 获取剩余字符串，substring(1) toLowweCase();
	 */
	...
	/*
	 * 获取指定字符串中，大写字母，小写字母，数字的个数 思想： 1.计数器，就是int变量，满足一个条件++
	 * 2.遍历字符串，长度方法length()+charAt()遍历 3.字符判断是大写，是小写，还是数字
	 */
	public static void getCount(String str){
		...
		for(int i = 0;i<str.length();i++){
			...
			char c = str.charAt(i);
			//利用编码表65-90 97-122 48-57 ,也可以用A-Z，a-z,0-9
			if(c >=65 && c <= 90){
				upper++;
			}else if(c >= 97&& c <= 122){
				lower++;
